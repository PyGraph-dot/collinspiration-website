  ...
  return (
    <div className="container mx-auto px-4 py-12 min-h-screen">
      ...
      <p className="mb-4 text-gray-700">
        By accessing and using the Collinspiration website (the &quot;Service&quot;), you accept and agree to be bound by the {/* CORRECTED: &quot;Service&quot; */}
      ...
      <p className="mb-4 text-gray-700">
        ...
        through its network of properties (the &quot;Service&quot;). You understand and agree that the Service {/* CORRECTED: &quot;Service&quot; */}
      ...
      <p className="mb-4 text-gray-700">
        ...
        harmful, threatening, abusive, harassing, tortious, defamatory, vulgar, obscene, libelous, invasive of another&apos;s privacy, hateful, {/* CORRECTED: another's */}
